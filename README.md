...
### Batch Functions (BF)
- 1/ Create '.txt' files containing the commands needed to 'batch-run' one of the Processing Function
(except for Processing Function #2 | Run MegaDetector)
...
------------------------------------------------------------------------------------------------------------------------
## Suggestions for when executing the functions

------------------------------------------------------------------------------------------------------------------------
### Suggestion | Processing Function (PF)

====================================================================
#### PF 1 | Create the `BatchInput` JSON file

- We suggest the name of the `BatchInput (BI)` JSON file should be saved in a `*_BatchInput/` folder, and its filename
should end it with `*_BI.json`, similar to the example below:

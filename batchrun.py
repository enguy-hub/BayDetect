...
def pf_batchrun():
    os.system(
        ...
        'python main.py < '
        'C:/LWF/BayDetect/metadata/Karwendel_Rohdaten/KW_BatchCmds/pf3_mdJSONToCSV/pf3_mdJSONToCSV_KW_035_Session_7_04102021.txt '
        '&& '
        'python main.py < '
        'C:/LWF/BayDetect/metadata/Karwendel_Rohdaten/KW_BatchCmds/pf3_mdJSONToCSV/pf3_mdJSONToCSV_KW_035_Session_8_04012022.txt '
        '&& '
        'python main.py < '
        'C:/LWF/BayDetect/metadata/Karwendel_Rohdaten/KW_BatchCmds/pf3_mdJSONToCSV/pf3_mdJSONToCSV_KW_035_Session_9_05102022.txt '
        '&& '
        'python main.py < '
        'C:/LWF/BayDetect/metadata/Karwendel_Rohdaten/KW_BatchCmds/pf3_mdJSONToCSV/pf3_mdJSONToCSV_KW_038_Session_6_07052021.txt '
        '&& '
        'python main.py < '
        'C:/LWF/BayDetect/metadata/Karwendel_Rohdaten/KW_BatchCmds/pf3_mdJSONToCSV/pf3_mdJSONToCSV_KW_038_Session_7_11102021.txt '
        '&& '
        'python main.py < '
        'C:/LWF/BayDetect/metadata/Karwendel_Rohdaten/KW_BatchCmds/pf3_mdJSONToCSV/pf3_mdJSONToCSV_KW_038_Session_8_01042022.txt '
        '&& '
        'python main.py < '
        'C:/LWF/BayDetect/metadata/Karwendel_Rohdaten/KW_BatchCmds/pf3_mdJSONToCSV/pf3_mdJSONToCSV_KW_038_Session_9_11102022.txt '
